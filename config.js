...
module.exports = {
    ...
    MENTION_RPLY: process.env.TAG_REPLY === undefined ? '919544846609@s.whatsapp.net' : process.env.TAG_REPLY,
    ...
    TAG: process.env.TAG_HEADER === undefined ? 'plk' : process.env.TAG_HEADER,
